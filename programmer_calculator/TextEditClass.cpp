...
TextEditClass::TextEditClass(QTextEdit *inputTextEdit, QTextEdit *outputTextEdit) :  InputTextEdit(inputTextEdit),OutputTextEdit(outputTextEdit)
{
}

TextEditClass::~TextEditClass()
{
}
/*********************************************************************************************************
函数名称：GetStingLen
...
备    注：
*********************************************************************************************************/
void TextEditClass::GetStingLen()const
{
...
备    注：
*********************************************************************************************************/
void TextEditClass::GetByteLen()const
{
    QString text = InputTextEdit->toPlainText();  // 获取输入QTextEdit中的文本
...
备    注：输出的十六进制数无前缀
*********************************************************************************************************/
void TextEditClass:: StingToHexNoPrefix() const
{
    QString text = InputTextEdit->toPlainText();  // 获取输入QTextEdit中的文本
...
备    注：输出的十六进制数有前缀
*********************************************************************************************************/
void TextEditClass::StingToHexHavePrefix () const
{
    QString text = InputTextEdit->toPlainText();  // 获取输入QTextEdit中的文本
    QByteArray byteArray = text.toUtf8();  // 将QString转换为QByteArray
...
备    注：无
*********************************************************************************************************/
void TextEditClass::ClearAllTextEdit() const
{
...
备    注：输出的字符串无间隔
*********************************************************************************************************/
void TextEditClass::HexToStingNoSpace() const
{
    // 获取输入文本
...
备    注：输出的字符串有间隔
*********************************************************************************************************/
void TextEditClass::HexToStingHaveSpace() const
{
    // 获取输入文本
    QString inputText = InputTextEdit->toPlainText();
    // 按照空格分割字符串
